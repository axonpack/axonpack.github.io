---
title: Installation
description: Install @axonpack/expo-devtools and its three peer dependencies.
---
...
[What needs a development build](/docs/expo-devtools/reference/development-build).
