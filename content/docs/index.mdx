...
<Cards>
  ...
  />
  <Card
    title="@axonpack/react-native-devtools-tab"
    href="/docs/react-native-devtools-tab"
    description="Your own tab in React Native DevTools, drawn from a component that runs in the app."
  />
  <Card
    title="@axonpack/react-pretty-print"
    href="/docs/react-pretty-print"
    description="Collapsible JSON and XML trees and a syntax highlighter, for React and React Native."
  />
</Cards>
